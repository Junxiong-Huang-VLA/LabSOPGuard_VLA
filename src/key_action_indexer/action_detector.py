...
def build_segments_from_scores(
    ...
    for interval in merged:
        ...
        segment = DetectedSegment(
            ...
            decision_path="motion.threshold_refine",
            decision_trace=[
                "backend=motion",
                f"sample_fps={config.sample_fps}",
                f"start_threshold={config.start_threshold}",
                f"end_threshold={config.end_threshold}",
                f"buffer_sec={config.buffer_sec}",
            ],
            fallback_used=False,
            fallback_reason="",
            reason_code="motion_threshold_detected",
            raw_score=_avg_score(scores, start_sec, end_sec, "motion_score"),
            final_score=_avg_score(scores, start_sec, end_sec, "active_score"),
        )
