...
class EventStructurer:
    ...
    def align_multiview_timestamp(self, events: List[Dict[str, Any]], camera_offsets_ms: Dict[str, int]) -> List[Dict[str, Any]]:
        aligned = []
        for e in events:
    ...
    def align_multi_camera_timestamp(self, events: List[Dict[str, Any]], camera_offsets_ms: Dict[str, int]) -> List[Dict[str, Any]]:
        return self.align_multiview_timestamp(events, camera_offsets_ms)
