...
& "C:\Users\Xx7\.conda\envs\LabSOPGuard\python.exe" -m key_action_indexer.cli evidence-package-build `
  --package-root "D:\LabEmbodied\outputs\experiments\<experiment_id>\material_references" `
  --key-action-index-dir "D:\LabEmbodied\outputs\experiments\<experiment_id>\key_action_index" `
  --source-manifest "D:\LabEmbodied\outputs\experiments\<experiment_id>\key_action_index\manifest.json" `
...
& "C:\Users\Xx7\.conda\envs\LabSOPGuard\python.exe" -m key_action_indexer.cli frontend-sync `
  --target-experiment-dir "D:\LabEmbodied\outputs\experiments\<experiment_id>" `
  --source-session-dir "D:\LabEmbodied\outputs\experiments\<experiment_id>" `
  --third-person-video "D:\LabVideo\raw_uploads\<experiment_id>\third.mp4" `
  --first-person-video "D:\LabVideo\raw_uploads\<experiment_id>\first.mp4" `
  --run-yolo-overlay `
  --require-yolo-overlay `
  --yolo-device auto `
  --output-summary "D:\LabEmbodied\outputs\experiments\<experiment_id>\reports\frontend_sync_summary.json"
```
...
& "C:\Users\Xx7\.conda\envs\LabSOPGuard\python.exe" -m key_action_indexer.cli frontend-sync `
  ...
  --validate-only `
  --require-yolo-overlay `
  --output-summary "D:\LabEmbodied\outputs\experiments\<experiment_id>\reports\frontend_sync_validation.json"
```
...
& "C:\Users\Xx7\.conda\envs\LabSOPGuard\python.exe" -m key_action_indexer.cli evidence-package-eval `
  --package-root "D:\LabEmbodied\outputs\experiments\<experiment_id>\material_references" `
  --queries "D:\LabEmbodied\outputs\experiments\<experiment_id>\reports\evidence_package_eval_queries.json" `
  --output "D:\LabEmbodied\outputs\experiments\<experiment_id>\reports\evidence_package_eval.json" `
  --limit 8
```
...
package = EvidencePackage.load(r"D:\LabEmbodied\outputs\experiments\<experiment_id>\material_references")
result = package.query("称量纸有没有移动", limit=8)

eval_result = evaluate_evidence_package_queries(
    package.root,
    r"D:\LabEmbodied\outputs\experiments\<experiment_id>\reports\evidence_package_eval_queries.json",
    output_path=r"D:\LabEmbodied\outputs\experiments\<experiment_id>\reports\evidence_package_eval.json",
)
```
