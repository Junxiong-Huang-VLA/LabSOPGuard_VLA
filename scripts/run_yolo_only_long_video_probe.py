...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--third-person-model", default=r"D:\LabModels\yolo\third_person\current\best.pt")
    parser.add_argument("--first-person-model", default=r"D:\LabModels\yolo\first_person\current\best.pt")
